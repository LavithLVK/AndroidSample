...
public class LeftFragmentThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.leftfragment3,container,false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        TextView txt=(TextView)getView().findViewById(R.id.left3);
        Bundle args=getArguments();
        txt.setText(args.getString("left3"));
        ImageView img1=(ImageView)getView().findViewById(R.id.l3image1);
        ImageView img2=(ImageView)getView().findViewById(R.id.l3image2);
//        URL url = null;
//        Bitmap bmp = null;
//        try {
...
//        img1.setImageURI(Uri.parse("https://image.flaticon.com/icons/svg/56/56735.svg"));
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((MainActivity)getActivity()).switchToFirstFragment("left",count1++);
            }
        });
        img2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivity)getActivity()).switchToSecondFragment("left",count2++);
            }
        });
    }
}

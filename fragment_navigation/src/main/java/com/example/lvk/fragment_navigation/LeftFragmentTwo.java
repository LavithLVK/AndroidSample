...
public class LeftFragmentTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.leftfragment2,container,false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        TextView txt=(TextView)getView().findViewById(R.id.left2);
        Bundle args=getArguments();
        txt.setText(args.getString("left2"));
        ImageView img1=(ImageView)getView().findViewById(R.id.l2image1);
        ImageView img3=(ImageView)getView().findViewById(R.id.l2image2);
//        URL url = null;
//        Bitmap bmp = null;
//        try {

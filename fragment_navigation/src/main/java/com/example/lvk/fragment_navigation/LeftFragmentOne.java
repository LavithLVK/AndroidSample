...
public class LeftFragmentOne extends Fragment {
    private static int count2=1;
    private static int count3=1;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.leftfragment1,container,false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        TextView txt=(TextView)getView().findViewById(R.id.left1);
        Bundle args=getArguments();
        txt.setText(args.getString("left1"));
        ImageView img2=(ImageView)getView().findViewById(R.id.l1image1);
        ImageView img3=(ImageView)getView().findViewById(R.id.l1image2);
//        URL url = null;
//        Bitmap bmp = null;
//        try {
...
//        img3.setImageURI(Uri.parse("https://image.flaticon.com/icons/svg/56/56587.svg"));
        ...
        img3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivity)getActivity()).switchToThirdFragment("left",count3++);
            }
        });
    }
}
